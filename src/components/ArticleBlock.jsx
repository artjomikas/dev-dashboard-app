...
const ActicleBlock = () => {
  return (
    <div className="bg-[#1C1F26] relative rounded-2xl flex flex-col h-full p-3 md:p-1.5 xl:p-3 max-w-[310px] w-full">
      ...
      <p className="font-semibold text-[20px] mt-4 break-words line-clamp-3 mb-5 leading-[27px]">
      ...
      <div className="flex flex-1 flex-col ">
        <img src={banner} alt="" className="object-cover h-40 rounded-2xl" />
      </div>
    </div>
  );
};
